  ...
  renderVals() {
    ...
    if (cc.league === 'pl') {
      if (cc.view === 'totalt') {
        ...
        clubDetail = this.buildRace(cfg);
        clubDetail.caption = 'Haalands Premier League-sesonger sammenlignet per serierunde. Alle fire vises som standard &mdash; bruk bryterne under for å fjerne en sesong.';
